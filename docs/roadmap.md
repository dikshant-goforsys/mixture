...
- [ ] Wire `MIXTURE_HOOK_PROFILE` env governance + CI validation of `hooks.json`
- [ ] Add the prompt-defense preamble + cost-aware model-routing reference
- [ ] CI: run `validate-frontmatter.mjs` + a no-drift check on every PR
